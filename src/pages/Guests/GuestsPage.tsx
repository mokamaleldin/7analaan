...
const GuestsPage = () => {
  ...
  return (
    <>
      <SEO
        title="ضيوف حان الآن | نخبة الخبراء في بودكاست حان الآن"
        description="تعرف على ضيوف بودكاست حان الآن واكتشف حلقاتهم ومقاطعهم. نخبة من الخبراء والمفكرين والمتخصصين في حان الآن."
        keywords={[
          'حان الآن',
          'بودكاست حان الآن',
          'ضيوف بودكاست',
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-8 leading-relaxed">
                تعرف على ضيوف حان الآن الذين شاركوا معنا في الحلقات السابقة
              </p>
            </div>
          </div>
        </div>
